                    ...
                    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
                        ...
                        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
                            <div data-kt-swapper="true"
                                ...
                                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Tema</h1>
                            </div>
                        ...
                        <div class="d-flex flex-column flex-column-fluid">
                                ...
                                <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                                    <div data-kt-swapper="true"
                                        ...
                                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1 d-none d-md-flex">
                                            ...
                                            <li class="breadcrumb-item text-muted">
                                                <a href="{{ route('admin.themes') }}">Kelola Tema</a>
                                            </li>
                                            <li class="breadcrumb-item"><span class="bullet bg-gray-500 w-5px h-2px"></span></li>
                                            <li class="breadcrumb-item text-muted">Detail Tema</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="kt_app_content" class="app-content flex-column-fluid">
                                <div id="kt_app_content_container" class="app-container container-fluid">
                                    ...
                                    <form action="{{ route('admin.edit-theme', ['id' => $theme['id']]) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="row mb-5 d-md-none">
                                            <div class="col-12">
                                                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                                    ...
                                                    <li class="breadcrumb-item"><span class="bullet bg-gray-500 w-5px h-2px"></span></li>
                                                    <li class="breadcrumb-item text-muted"><a href="{{ route('admin.themes') }}">Kelola Tema</a></li>
                                                    <li class="breadcrumb-item"><span class="bullet bg-gray-500 w-5px h-2px"></span></li>
                                                    <li class="breadcrumb-item text-muted">Detail Tema</li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex flex-stack flex-wrap">
                                                    <h3 class="m-md-0">Detail Tema</h3>
                                                    <a href="{{ route('admin.themes') }}" class="btn btn-light-primary">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="card card-flush py-4 mb-5 mb-xl-10">
                                                    <div class="card-header">
                                                        <div class="card-title"><h2>Status Tema</h2></div>
                                                        <div class="card-toolbar">
                                                            <div class="rounded-circle {{ $theme['deleted_at'] ? 'bg-danger' : 'bg-success' }} w-15px h-15px"></div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card card-flush py-4">
                                                    ...
                                                    <div class="card-body pt-0">
                                                        <div class="mb-5">
                                                            ...
                                                            <div class="fw-semibold fs-6">{{ $theme['created_at'] }}</div>
                                                        </div>
                                                        @if ($theme['deleted_at'])
                                                        <div class="mb-0">
                                                            <label class="form-label fw-semibold text-muted fs-7 text-uppercase">Dihapus Pada</label>
                                                            <div class="fw-semibold fs-6 text-danger">{{ $theme['deleted_at'] }}</div>
                                                        </div>
                                                        @endif
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="card-body pt-0">
                                                        ...
                                                        <div class="mb-5 mb-xl-10">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" name="name" value="{{ old('name') ?? $theme['name'] }}" required />
                                                            </div>
                                                        </div>
                                                        <!--end::Input group-->
                                                        ...
                                                        <div class="mb-5 mb-xl-10">
                                                            ...
                                                            <div class="input-group">
                                                                <textarea class="form-control" rows="4" name="description" required>{{ old('description') ?? $theme['description'] }}</textarea>
                                                            </div>
                                                        </div>
                                                        <!--end::Input group-->
                                    ...
                                    @if ($theme['deleted_at'])
                                        <form action="{{ route('admin.restore-theme', ['id' => $theme['id']]) }}" method="POST" class="w-100 d-flex justify-content-end">
                                            @csrf
                                            @method('PATCH')
                                            <div class="card-footer bg-white text-end py-3 px-4">
                                                <button type="submit" class="btn btn-secondary d-flex align-items-center gap-3">
                                                    <img src="{{ asset('icons/history.svg') }}" alt="" class="h-12em"> Kembalikan Tema
                                                </button>
                                            </div>
                                        </form>
                                    @else
                                        <form action="{{ route('admin.delete-theme', ['id' => $theme['id']]) }}" method="POST" class="w-100 d-flex justify-content-end">
                                            @csrf
                                            @method('DELETE')
                                            <div class="card-footer bg-white text-end py-3 px-4">
                                                <button type="submit" class="btn bg-danger-subtle d-flex align-items-center gap-3 text-danger">
                                                    <img src="{{ asset('icons/trash.svg') }}" alt="" class="h-12em img-accent"> Hapus Tema
                                                </button>
                                            </div>
                                        </form>
                                    @endif
                                    ...
                                    @else
                                    <div class="alert alert-danger">Terjadi kesalahan saat memuat data tema.</div>
                                    @endif
