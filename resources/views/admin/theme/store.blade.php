	...
	<body
						...
						<div class="d-flex flex-column flex-column-fluid">
								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
									<div
										...
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1 d-none d-md-flex">
											...
											<li class="breadcrumb-item text-muted">Tambahkan Tema</li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								<div id="kt_app_content_container" class="app-container container-fluid">
									...
									<form action="{{ route('admin.add-theme') }}" method="POST">
										@csrf
										...
										<div class="row g-5 g-xl-10 mb-5 mb-xl-10">
											...
											<div class="col-12">
												<div class="d-flex flex-stack flex-wrap">
													<h3 class="m-md-0">Tambahkan Tema</h3>
											...
											<div class="col-md-8">
												<div class="card card-flush py-4">
													...
													<div class="card-body pt-0">
														...
														<!--begin::Deskripsi-->
														<div class="mb-0">
															<label class="form-label required">Deskripsi Tema</label>
											...
											<div class="col-12">
												<div class="d-flex flex-end">
													<a href="{{ route('admin.themes') }}" class="btn btn-secondary me-3">
														Batal
													</a>
		...
		<script defer>
			function handler_status_active(e) {
				...
				document.getElementById('kt_status_tema').classList.add(e.checked ? 'bg-success' : 'bg-danger');
				document.getElementById('kt_status_tema').classList.remove(e.checked ? 'bg-danger' : 'bg-success');
			}
		</script>
