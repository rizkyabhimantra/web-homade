			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
				...
				@include('components.sidebar', ["page" => "category"])
					...
					<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                        ...
                        <div class="d-flex w-100 h-100 align-items-center px-5 justify-content-center flex-column">
                            <div class="d-flex flex-column px-10 py-15 w-100 w-sm-400px border-homade-1 rounded-3 gap-3">
