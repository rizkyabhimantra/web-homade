...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
	...
	<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
		...
		<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
			...
			<!--begin::Header-->
			<div id="kt_app_header" class="app-header d-lg-none" data-kt-sticky="true"
			...
			<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
				...
				<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
					...
					<div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
						<a href="signin"
							class="btn btn-primary-homade btn-flex flex-center overflow-hidden text-nowrap px-0 h-40px w-100"
				...
				<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
					...
					<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<a href="#" class="btn btn-sm fw-bold" data-bs-toggle="modal"
										data-bs-target="#kt_modal_new_target">Tambah Menu Baru</a>
									<!--end::Primary button-->
								</div>
								<!--end::Actions-->
						...
						<div id="kt_app_content" class="app-content flex-column-fluid">
							<!-- // hapus ini bukan tempalte soalnya di bawah ini... -->
							@if(isset($response['status']) && $response['status'] === 'success')
								@php
									$data = $response['data'];
									$period = $data['period'] ?? 'this_month';

									// Karena pakai DB::table()->first(), kembaliannya object. Jika array, sesuaikan jadi $data['stats']['total_revenue']
									$stats = $data['stats'];
									$deliveryToday = $data['delivery_today'];
									$master = $data['master'];
									$popularMenus = $data['popular_menus'];
								...
								<div class="d-flex flex-wrap flex-stack mb-6">
									<h3 class="fw-bold my-2">
										...
										<span class="fs-6 text-gray-400 fw-semibold ms-1">Katering Kita</span>
									</h3>

									<div class="d-flex align-items-center my-2">
										<div class="btn-group" role="group">
											<a href="?period=today"
												class="btn btn-sm {{ $period == 'today' ? 'btn-primary' : 'btn-light btn-active-light-primary' }}">Hari
												Ini</a>
											<a href="?period=this_week"
												class="btn btn-sm {{ $period == 'this_week' ? 'btn-primary' : 'btn-light btn-active-light-primary' }}">Minggu
												Ini</a>
											<a href="?period=this_month"
												class="btn btn-sm {{ $period == 'this_month' ? 'btn-primary' : 'btn-light btn-active-light-primary' }}">Bulan
												Ini</a>
										</div>
									</div>
								</div>
								...
								<div class="row g-5 g-xl-8 mb-8">
									<div class="col-xl-4">
										<div class="card bg-success hoverable card-xl-stretch border-0">
											<div class="card-body">
												<i class="bi bi-wallet2 text-white fs-2x mb-3"></i>
												<div class="text-white fw-bold fs-2 mb-2 mt-2">Rp
													{{ number_format($stats->total_revenue ?? 0, 0, ',', '.') }}</div>
												<div class="fw-semibold text-white">Total Pendapatan
													({{ str_replace('_', ' ', Str::title($period)) }})</div>
											</div>
										</div>
									</div>

									<div class="col-xl-4">
										<div class="card bg-primary hoverable card-xl-stretch border-0">
											<div class="card-body">
												<i class="bi bi-cart-check text-white fs-2x mb-3"></i>
												<div class="text-white fw-bold fs-2 mb-2 mt-2">
													{{ $stats->total_transactions ?? 0 }} Pesanan</div>
												<div class="fw-semibold text-white">Total Transaksi</div>
											</div>
										</div>
									</div>
									...
									<div class="col-xl-4">
										<div
											class="card {{ $deliveryToday > 0 ? 'bg-danger' : 'bg-dark' }} hoverable card-xl-stretch border-0">
											<div class="card-body">
												<i class="bi bi-truck text-white fs-2x mb-3"></i>
												<div class="text-white fw-bold fs-2 mb-2 mt-2">{{ $deliveryToday }} Box
												</div>
												<div class="fw-semibold text-white">Harus Dikirim HARI INI</div>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row g-5 g-xl-8 mb-8">
									<div class="col-xl-8">
										<div class="card card-flush shadow-sm border-0 mb-5">
											<div class="card-header pt-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label fw-bold text-dark">Status Dapur & Kurir</span>
													<span class="text-gray-400 mt-1 fw-semibold fs-6">Pantauan pesanan yang
														belum selesai</span>
												</h3>
											</div>
											<div class="card-body pt-5">
												<div class="d-flex flex-wrap align-items-center justify-content-between">
													<div
														class="d-flex flex-column text-center px-4 py-3 border border-dashed rounded">
														<span
															class="fs-2hx fw-bold text-warning">{{ $stats->waiting_process ?? 0 }}</span>
														<span class="text-gray-400 fw-semibold">Menunggu Proses</span>
													</div>
													<i class="bi bi-arrow-right text-gray-300 fs-2x"></i>
													<div
														class="d-flex flex-column text-center px-4 py-3 border border-dashed rounded">
														<span
															class="fs-2hx fw-bold text-primary">{{ $stats->on_process ?? 0 }}</span>
														<span class="text-gray-400 fw-semibold">Sedang Dimasak</span>
													</div>
													<i class="bi bi-arrow-right text-gray-300 fs-2x"></i>
													<div
														class="d-flex flex-column text-center px-4 py-3 border border-dashed rounded">
														<span
															class="fs-2hx fw-bold text-info">{{ $stats->waiting_courier ?? 0 }}</span>
														<span class="text-gray-400 fw-semibold">Menunggu Kurir</span>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="card card-flush shadow-sm border-0">
											<div class="card-header pt-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label fw-bold text-dark">Statistik Penjualan</span>
												</h3>
											</div>
											<div class="card-body pt-0 ps-0 pe-5">
												<div id="kt_charts_widget_sales" style="height: 300px"></div>
											</div>
										</div>
									</div>
									...
									<div class="col-xl-4">
										<div class="card card-flush shadow-sm border-0 mb-5">
											<div class="card-header pt-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label fw-bold text-dark">Top 5 Menu Terlaris</span>
												</h3>
											</div>
											<div class="card-body pt-5">
												@forelse($popularMenus as $index => $pm)
													<div class="d-flex align-items-sm-center mb-7">
														<span
															class="badge badge-light-{{ $index == 0 ? 'success' : 'primary' }} fs-5 fw-bold me-4 px-3 py-2">{{ $index + 1 }}</span>
														<div class="d-flex flex-row-fluid flex-wrap align-items-center">
															<div class="flex-grow-1 me-2">
																<span class="text-gray-800 fw-bold fs-6">{{ $pm->name }}</span>
															</div>
															<span
																class="badge badge-light-danger fw-bold my-2">{{ $pm->total_sold }}
																Terjual</span>
														</div>
													</div>
												@empty
										...
										<div class="card card-flush shadow-sm border-0">
											<div class="card-header pt-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label fw-bold text-dark">Data Sistem</span>
												</h3>
											</div>
											<div class="card-body pt-5">
												<div class="d-flex justify-content-between mb-4">
													<span class="text-gray-600 fw-semibold">Total Menu Aktif</span>
													<span
														class="text-gray-800 fw-bold">{{ $master['total_menus'] ?? 0 }}</span>
												</div>
												<div class="d-flex justify-content-between mb-4">
													<span class="text-gray-600 fw-semibold">Total Kategori</span>
													<span
														class="text-gray-800 fw-bold">{{ $master['total_categories'] ?? 0 }}</span>
												</div>
												<div class="d-flex justify-content-between mb-4">
													<span class="text-gray-600 fw-semibold">Total Paket</span>
													<span
														class="text-gray-800 fw-bold">{{ $master['total_packages'] ?? 0 }}</span>
												</div>
												<div class="d-flex justify-content-between">
													<span class="text-gray-600 fw-semibold">Jadwal Minggu Ini</span>
													<span
														class="text-gray-800 fw-bold badge badge-light-success">{{ $master['scheduled_this_week'] ?? 0 }}
														Menu</span>
												</div>
											</div>
										</div>
								...
								<script>
									document.addEventListener('DOMContentLoaded', function () {
										// Ambil data chart dari Backend PHP ke JS
										var rawChartData = @json($chartData);

										// Format data untuk ApexCharts
										var dates = rawChartData.map(item => item.date);
										var revenues = rawChartData.map(item => item.daily_revenue);

										var element = document.getElementById('kt_charts_widget_sales');
										...
										var options = {
											...
											stroke: {
												...
												show: true,
												width: 3,
												colors: ['#009EF7'] // Primary color metronic
											},
											xaxis: {
												categories: dates,
							...
							@else
								<div class="alert alert-danger shadow-sm border-0 d-flex align-items-center m-4">
									...
									<div>
										<strong>Gagal Memuat Dashboard!</strong> Sistem gagal mengambil data. Pesan:
