...
<body class="d-flex flex-column">
    @if ($response['status_code'] === 200)
        ...
        <div class="d-flex align-items-center justify-content-center flex-column gap-5 w-100">
            ...
            <div
                class="d-flex align-items-stretch flex-column flex-lg-row justify-content-center gap-5 w-95 w-sm-60 w-lg-95 w-xl-85 mt-5">
                ...
                <div class="w-99 w-lg-55 w-xl-65 flex-shrink-0 align-items-center justify-content-center flex-column">
                    ...
                    <!-- begin::pick address -->
                    <div
                        class="d-flex align-items-center justify-content-center border-grey-1 px-5 py-10 rounded-4 mb-10 w-100">
                        <button onclick="togglePopUp()" class="d-flex w-100 h-70px gap-4 overflow-hidden">

                            <div
                                class="d-flex align-items-center justify-content-center flex-shrink-0 h-100 ratio-1 bg-light-accent rounded-3">
                            ...
                            <div class="d-flex flex-column w-100 h-100 justify-content-center overflow-hidden">
                                ...
                                <p class="fsc-2 mb-0 w-100 text-start overflow-hidden text-overflow text-nowrap"
                    ...
                    <form action="{{ route('user.create-order') }}" method="post"
                        class="d-flex align-items-center justify-content-center flex-column border-grey-1 p-5 rounded-4 mb-10 w-100">
                        @csrf

                        <div class="d-flex w-100 mb-5 flex-column">
                            <p class="fsc-2 mb-1 fw-bold">Catatan Pemesanan</p>
                            <textarea name="note"
                                class="px-2 py-3 d-flex w-100 min-h-100px max-h-300px border-grey-1 rounded-1"></textarea>
                        </div>
                        ...
                        <div class="d-flex w-100 h-70px gap-4 mb-5 overflow-hidden">
                            ...
                            <div class="d-flex h-100 ratio-1 align-items-center justify-content-center flex-shrink-0">
                                <p class="fsc-3 mb-0 fw-bolder w-100 text-start text-nowrap">Rp
                                    {{ number_format($response['data']['transaction']['sub_total'], 2, ',', '.') }}</p>
                            </div>
                        ...
                        <button type="button" onclick="submitOrder()"
                            class="w-100 bg-accent rounded-3 align-items-center justify-content-center d-flex py-5 fsc-3 text-white fw-bold">Pesan</button>
                ...
                <div
                    class="d-flex align-items-center overflow-hidden w-100 h-max flex-column rounded-5 border-grey-1 py-5 min-w-0">

                    <div class="d-flex align-items-center justify-content-center flex-column w-100 px-10">

                        <p class="fsc-3 fw-black d-flex align-items-center w-100 gap-5"><img
                                src="{{ asset('icons/bag.svg')}}" class="h-1em img-accent">Ringkasan Pesanan</p>

                        <div
                            class="d-flex w-100 h-50px px-3 rounded-3 align-items-center justify-content-between flex-shrink-0 border-grey-1 mb-3">
            ...
            : 'Pesanan Pre Order' }}
                        ...
                        <div
                            class="d-flex w-100 h-50px px-3 rounded-3 align-items-center justify-content-between flex-shrink-0 border-grey-1 mb-5">
                            <p class="fsc-2 mb-0">Tanggal Pengiriman</p>
                            <p class="fsc-2 mb-0">
                                {{\Carbon\Carbon::parse($response['data']['delivery_info']['delivery_at'])->translatedFormat('d F Y')}}
                            </p>
                        </div>
                            ...
                            @foreach ($response['data']['summary_orders']['items'] as $item)
                                @foreach ($item['packages'] as $package)
                                    ...
                                    <div class="d-flex w-100 h-50px overflow-hidden gap-3 flex-shrink-0">
                                        ...
                                        <div
                                            class="d-flex align-items-center flex-shrink-0 justify-content-center h-100 ratio-1 border-grey-1 rounded-3">
                                        ...
                                        <div class="d-flex flex-column overflow-hidden min-w-0 flex-grow-1 h-100">
                                            <p class="fsc-2 h-50 w-100 text-nowrap overflow-hidden text-overflow fw-black mb-0">
                                                {{ $item['name'] }}</p>
                                            <p class="fsc-1 h-50 mb-0">{{ $package['name'] }}</p>
                                        </div>

                                        <div class="d-flex flex-column flex-shrink-0 align-items-end">
                                            <p class="fsc-2 mb-0">Rp
                                                {{ number_format($package['price'] * $package['quantity'], 0, ',', '.') }}</p>
                                        </div>
                        ...
                        <div class="d-flex mt-3 justify-content-between align-items-center w-100">
                            ...
                            <p class="fsc-2 mb-0" id="orderSubtotal">Rp
                                {{ number_format($response['data']['transaction']['sub_total'], 2, ',', '.') }}</p>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center w-100">
                            ...
                            <p class="fsc-2 mb-0" id="orderSubtotal">Rp
                                {{ number_format($response['data']['transaction']['shipping_cost'], 2, ',', '.') }}</p>
                        </div>

                        <div class="d-flex mt-3 justify-content-between align-items-center w-100">
                            <p class="fsc-2 fw-bold mb-0">Total Pembayaran</p>
                            <p class="fsc-2 fw-bold mb-0" id="orderTotal">Rp
                                {{ number_format($response['data']['transaction']['sub_total'], 2, ',', '.') }}</p>
                        </div>
            ...
            <div class="d-none2 align-items-center justify-content-center pop-up" id="PopUp">
                <div
                    class="d-flex align-items-center justify-content-center w-99 w-sm-85 w-md-51 h-80 bg-white flex-column gap-5 rounded-4 p-5 px-10">

                    <div class="d-flex w-100 align-items-stretch justify-content-between">
                        <p class=" fsc-4 fsc-md-3 mb-0 fw-bold">Pilih Alamat</p>

                        <button class="h-100 ratio-1 align-items-center justify-content-center d-flex bg-accent rounded-2"
                            onclick="togglePopUp()">
                    ...
                    <div
                        class="d-flex align-items-center flex-column {{ $response['data']['delivery_info']['user_address'] ? '' : 'justify-content-center' }} gap-3 w-100 h-100 overflow-scroll">
                        ...
                        @if ($response['data']['delivery_info']['user_address'])
                            ...
                            @foreach ($response['data']['delivery_info']['user_address'] as $address)
                                <button
                                    ...
                                    data-id="{{ $address['id'] }}" data-name="{{ $address['received_name'] }}"
                                    data-address="{{ $address['address'] }}" onclick="selectAddress(this)">
                                    <p
                                        class="fsc-2 mb-3 text-start fw-bold rounded-pill bg-accent text-white px-4 py-1 py-md-0 w-max">
                                        {{ $address['label'] }}
                                    </p>
                                    ...
                                    <p class="fsc-1 mb-0 w-100 text-start text-nowrap overflow-hidden text-overflow">
                                        {{ $address['address'] }}</p>
                                </button>
                            @endforeach
                        ...
                        @else
                            ...
                            <a href="{{ route('user.user-address') }}"
                                class="bg-accent py-2 px-5 fsc-2 fw-bold rounded-3 text-white d-flex align-items-center justify-content-center">Tambah
                                Alamat</a>
            ...
            <div
                class="d-flex align-items-center justify-content-center flex-column flex-md-row mt-5 w-95 w-sm-45 w-md-85 h-md-125px gap-10">

                <div
                    class="d-flex w-100 h-100 bg-beige rounded-5 py-5 py-md-0 justify-content-center align-items-center flex-column">
    ...
    @else
        ...
        <div class="d-flex align-items-center justify-content-center w-100 h-100 flex-column">
            ...
            <a href="{{ route('user.schedules') }}"
                class="fsc-2 w-max bg-accent px-4 py-2 rounded-3 text-white fw-bold">Back</a>
        </div>
