				...
				<div class="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
					...
					<div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
						...
						<div class="py-20">
							...
							<!--begin::Form-->
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="{{ route('user.forgot-password') }}" method="POST">
                            @csrf
								<!--begin::Body-->
								<div class="card-body">
									<!--begin::Heading-->
									<div class="text-start mb-10 align-items-center d-flex flex-column">
										...
										<h1 class="text-white mb-3 fs-3x text-center w-100" data-kt-translate="sign-in-title">Lupa Password</h1>
										<h3 class="text-white mb-3 fs-1x fw-light text-center w-100" data-kt-translate="sign-in-title">Masukan email anda jika anda lupa password anda</h3>
										<!--end::Title-->
									</div>
									<!--begin::Heading-->
									<!--begin::Input group=-->
                                    ...
                                    <div class="d-flex w-100 justify-content-center mt-2 flex-column align-items-center">
                                        <a href="{{ route('user.signin') }}" class="fw-bold fs-5 text-accent" data-kt-translate="sign-in-head-link">Kembali</a>
                                    </div>
                                </div>
								<!--begin::Body-->
							</form>
