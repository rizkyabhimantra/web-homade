...
<nav class="bg-nav h-90 flex-shrink-0 d-flex flex-column align-items-center justify-content-center overflow-hidden">
    <div class="d-flex mb-5 w-100 gap-5 h-40px align-items-center justify-content-center">
        ...
        <a href="/" class="{{ $page == "home" ? 'text-yellow' : 'text-white fw-light' }} fsc-4 me-3">Home</a>
        <a href="/menus" class="{{ $page == "menu" ? 'text-yellow' : 'text-white fw-light' }} fsc-4 me-3">Menu</a>
        <a href="/schedule" class="{{ $page == "schedule" ? 'text-yellow' : 'text-white fw-light' }} fsc-4 me-3">Jadwal</a>
        <a href="/profile" class="{{ $page == "profile" ? 'text-yellow' : 'text-white fw-light' }} fsc-4 me-3">Profil</a>
        <a href="/contact" class="{{ $page == "contact" ? 'text-yellow' : 'text-white fw-light' }} fsc-4 me-3">Kontak</a>
    ...
    <div class="d-flex w-100 mb-5 flex-column">
        ...
        <p class="text-center text-white w-100 fsc-2 fw-light">Catering harian tanpa langganan, masakan rumahan, hemat, enak, bersih di Jakarta</p>
    </div>
