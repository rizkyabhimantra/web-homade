...
<div class="d-flex w-100 min-h-100 p-15 px-5 px-md-15 bg-accent">
    <div class="d-flex flex-column bg-white p-10 align-items-center justify-content-between w-100">
        ...
        <p class=" w-100 fsc-3 text-center fw-bold text-accent">Bukti Pembayaran Pesanan Anda Ditolak</p>

        <div class="d-flex w-100 h-100 flex-column align-items-center justify-content-center">

            
            @if ($transaction['cancelled_reason'] )
            <p class=" w-100 text-center fsc-2 mb-1"><span class="fsc-2 fw-bold">Alasan:</span> {{ $transaction['cancelled_reason'] }}</p>
            <br><br>
            @endif
